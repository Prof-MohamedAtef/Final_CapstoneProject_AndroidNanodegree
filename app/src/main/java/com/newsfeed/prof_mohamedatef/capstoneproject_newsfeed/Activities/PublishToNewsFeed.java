...
//        mDatabase.keepSynced(true);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_publish_to_news_feed);
...
//            mDatabase.keepSynced(true);
        ...
        detailToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onBackPressed();
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(PublishToNewsFeed.this);
                Intent intent = new Intent(PublishToNewsFeed.this, HomeActivity.class);
...
//AudioFilePath is global string. it contains the Uri to the recently recorded audio.
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode != RESULT_CANCELED&&data!=null){
            ActivityCompat.requestPermissions(PublishToNewsFeed.this,
            ...
            reference.putFile(Audio)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(PublishToNewsFeed.this, getResources().getString(R.string.uploaded), Toast.LENGTH_SHORT).show();
                            reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    String Image= firebaseImageHelper.getImageFileUri().toString();
                                    firebaseDataHolder.setImageFileUri(Image.toString());
                                    firebaseDataHolder.setAudiourl(Audio.toString());
                                    if (firebaseDataHolder != null) {
                                        Config.ActivityNum=3;
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(PublishToNewsFeed.this, getResources().getString(R.string.failed), Toast.LENGTH_SHORT).show();
                        }
                    })
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    UserChangeListener(currentArticleID);
                                    Config.FirebaseImageHelper=firebaseImageHelper;
                                    ImageHasUploaded=true;
//                                    if (firebaseImageHelper != null) {
//                                        InsertClass insertClass = new InsertClass();
//                                        insertClass.TryUpdateFirebaseReportImge(mRoomDatabase, firebaseImageHelper, POSTActivity, REPORTS_KEY);
//                                    }
                                }
                            });
                        }
